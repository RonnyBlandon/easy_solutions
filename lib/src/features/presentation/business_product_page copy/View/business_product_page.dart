...
class BusinessProductPage extends StatefulWidget {
  final ProductDetailEntity productDetailEntity;
  const BusinessProductPage({super.key, required this.productDetailEntity});

  @override
  State<BusinessProductPage> createState() => _BusinessProductPageState();
}

class _BusinessProductPageState extends State<BusinessProductPage> {
...
extension PrivateMethods on _BusinessProductPageState {
