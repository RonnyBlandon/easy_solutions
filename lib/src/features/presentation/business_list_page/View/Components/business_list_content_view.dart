...
class BusinessListContentView extends StatelessWidget {
  final BusinessListViewModel viewModel;
  const BusinessListContentView({super.key, required this.viewModel});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        _businessList(context, viewModel.businessList),
      ],
    );
  }
}
...
Widget _businessList(
    BuildContext context, List<BusinessDetailEntity> businessList) {
  return SizedBox(
    ...
    child: ListView.builder(
      ...
      itemBuilder: (BuildContext context, index) {
        ...
        return _cardBusinnes(context, business);
      },
    ),
  );
}
