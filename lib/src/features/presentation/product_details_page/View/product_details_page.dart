...
class ProductDetailsPage extends StatefulWidget {
  ...
  const ProductDetailsPage({super.key, required this.productDetailEntity});
...
extension PrivateMethods on _ProductDetailsPageState {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              headerText(
                  text: "L $productPrice", color: Colors.green, fontsize: 24.0),
              IconButton(
                  onPressed: () {},
                  iconSize: 30.0,
  ...
  Widget _addCart(BuildContext context, String totalPrice) {
    return Container(
      color: Colors.white,
