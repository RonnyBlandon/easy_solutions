...
Widget _addressContainer(BuildContext context,
    {required String type, required String address, required bool isSelected}) {
  return Container(
                ...
                onPressed: () {
                  showModalBottomSheet(
                    ...
                    builder: (context) => _buildBottomSheetContent(context,
                        address: address, isSelected: isSelected),
                  );
                },
                icon: Icon(
                  Icons.more_vert,
...
Widget _buildBottomSheetContent(BuildContext context,
    {required String address, required bool isSelected}) {
  return Container(
    height: screenHeight.getScreenHeight(context: context, multiplier: 0.4),
