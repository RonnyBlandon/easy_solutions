...
class RestaurantMenuProductsContentView extends StatelessWidget with BaseView {
  final List<BusinessCategoryEntity> businessCategories;
  RestaurantMenuProductsContentView(
      {super.key, required this.businessCategories});
        ...
        Container(
          ...
          child: Column(
            children: [
              GestureDetector(
                onTap: () {
                  MainCoordinator().showProductDetailsPage(
