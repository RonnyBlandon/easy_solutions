...
class CategoriesDecodable {
  ...
  final List<CategoryDecodable> categories;
  ...
  factory CategoriesDecodable.fromMap(Map<String, dynamic> json) =>
      CategoriesDecodable(
        categories: json["categories"] == null
            ? []
            : List<CategoryDecodable>.from(
                (json["categories"] as List<dynamic>).map(
                  (x) => CategoryDecodable.fromMap(x),
                ),
              ),
      );
...
class CategoryDecodable {
  ...
  factory CategoryDecodable.fromJson(String str) =>
      CategoryDecodable.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CategoryDecodable.fromMap(Map<String, dynamic> json) =>
      CategoryDecodable(
        name: json["name"],
