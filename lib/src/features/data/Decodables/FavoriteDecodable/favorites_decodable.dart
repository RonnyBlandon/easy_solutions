...
class FavoritesListDecodable {
  FavoritesListDecodable({required this.favoritesList});
...
class FavoriteDecodable {
  ...
  FavoriteDecodable({this.userId, this.businessId, this.productId, this.id});

  factory FavoriteDecodable.fromJson(String str) =>
      FavoriteDecodable.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory FavoriteDecodable.fromMap(Map<String, dynamic> json) =>
      FavoriteDecodable(
        userId: json["user_id"],
